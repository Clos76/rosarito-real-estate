    ...
    <section className="w-full px-6 mt-6 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ">
          {homes.map((home) => (
            <Link href={`/property/${home.id}`} key={home.id}>
              <div className="bg-white rounded shadow hover:shadow-md transition overflow-hidden ring-2 ring-white hover:ring-blue-500 relative h-64">
