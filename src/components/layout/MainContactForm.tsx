...
export default function ContactForm() {
    ...
    // FIXED: Input sanitization function - preserves spaces
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        ...
        // FIXED: For message field, preserve spaces during typing
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // FIXED: Sanitize message only on submit, not during typing
            const submitData = {
                ...formData,
            ...
            <div className="w-full max-w-2xl">
                ...
                <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 shadow-2xl">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* Message - FIXED: Added better styling and spacing */}
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                onChange={handleInputChange}
                                rows={4}
                                className="w-full px-4 py-3 bg-white/20 border border-white/30 rounded-xl text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 resize-none leading-relaxed"
